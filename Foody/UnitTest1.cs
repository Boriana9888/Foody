...
namespace Foody
{
    ...
    public class FoodyTests
    {
        ...
        private static string createdFoodId;//change if different condition
        private const string baseUrl = "http://softuni-qa-loadbalancer-2137572849.eu-north-1.elb.amazonaws.com:86";//change

        [OneTimeSetUp]

        public void Setup()
        {
            string token = GetJwtToken("boryana931", "bor1234bor1234");//my personal creds
        ...
        public void EditFoodTitle_ShouldReturnOk()
        {
            ...
            new {path = "/name", op = "replace", value = "Updates food name"}
